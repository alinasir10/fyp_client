...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-4 right-[50%] translate-x-[50%] z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:flex-col md:max-w-sm",
      className
    )}
    {...props}
  />
...
//         success:
//           "group border-green-500 bg-green-500 text-green-50",
//       },
//     },
//     defaultVariants: {
//       variant: "default",
